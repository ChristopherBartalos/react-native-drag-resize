...
const PADDING_CONNECTOR_BOX = 14;
...
export class DragResizeBlock extends Component {
  constructor(props) {
    ...
    const { x, y, w, h, minW, minH, visible, connectorSize } = props;
  ...
  render() {
    const { children, isDisabled, zIndex, visible } = this.props;
      ...
      return (
        <View
          style={{
            ...
            width: w,
            height: h,
            padding: PADDING_CONNECTOR_BOX / 2,
